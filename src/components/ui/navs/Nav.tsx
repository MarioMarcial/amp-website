...
import { appSectionsData } from './../../../data';
...
export const Nav = () => {
  ...
  return (
    <nav className="bg-dark-rich-100 outline-primary/10 outline-1 md:outline-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:py-6">
        <Link
          to="/"
          className="flex space-x-2 rtl:space-x-reverse justify-start"
        >
          <img
            src="/images/Logo-v12.png"
            className="h-12  object-contain self-start pointer-events-none"
            alt="Arte Musical Puebla Logo"
          />
          <span className="self-center text-xs text-gray-50 font-semibold whitespace-nowrap md:hidden">
            Arte Musical Puebla
          </span>
        </Link>
        <button
