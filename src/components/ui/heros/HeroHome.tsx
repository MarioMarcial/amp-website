...
export const HeroHome = ({ title, description, image }: HeroHomeProps) => {
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto px-4 py-12 md:grid md:grid-cols-2 md:gap-1 md:px-8 md:py-15 lg:grid-cols-5 lg:gap-5 lg:py-25 xl:px-0">
        ...
        <div className="justify-self-center mt-1 md:justify-self-end lg:col-span-2 lg:mt-0">
          <img
            ...
            className="w-full max-w-50 mx-auto md:max-w-85 md:mask-radial-from-69% md:mask-radial-to-70% lg:max-w-120"
            alt="hero imagen"
            loading="lazy"
          />
